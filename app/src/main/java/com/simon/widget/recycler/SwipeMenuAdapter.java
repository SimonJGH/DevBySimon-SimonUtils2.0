    ...
    public final VH onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mSwipeMenuCreator != null) {
            SwipeMenuLayout swipeMenuLayout = (SwipeMenuLayout) LayoutInflater.from(parent.getContext()).inflate(R.layout
                    .recyclerview_item_default, parent, false);
            ...
            if (leftMenuCount > 0) {
                ...
                swipeLeftMenuView.bindMenu(swipeLeftMenu, SDRecyclerView.LEFT_DIRECTION);
            ...
            if (rightMenuCount > 0) {
                ...
                swipeRightMenuView.bindMenu(swipeRightMenu, SDRecyclerView.RIGHT_DIRECTION);
