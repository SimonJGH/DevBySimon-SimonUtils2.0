...
public class Https {
	 ...
	 * @param callBack
	 */
	public void get(String url, CommonCallBack<? extends Object> callBack) {
		get(url, null, callBack);
	}

	public void get(String url, CommonParams params,
			CommonCallBack<? extends Object> callBack) {
		sendRequest(httpClient, httpContext,
				new HttpGet(getUrlWithQueryString(url, params)), null, callBack);
	}

	public void get(String url, Header[] headers, CommonParams params,
			CommonCallBack<? extends Object> callBack) {
	...
	public Object getSync(String url, CommonParams params) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		return sendSyncRequest(httpClient, httpContext, request, null);
	}

	public Object getSync(String url, Header[] headers, CommonParams params) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		if (headers != null)
			request.setHeaders(headers);
		return sendSyncRequest(httpClient, httpContext, request, null);
	 ...
	 * @param callBack
	 */
	public void post(String url, CommonCallBack<? extends Object> callBack) {
		post(url, null, callBack);
	}

	public void post(String url, CommonParams params,
			CommonCallBack<? extends Object> callBack) {
	...
	public <T> void post(String url, Header[] headers, CommonParams params,
			String contentType, CommonCallBack<T> callBack) {
	...
	public void post(String url, Header[] headers, HttpEntity entity,
			String contentType, CommonCallBack<? extends Object> callBack) {
	...
	public Object postSync(String url, CommonParams params) {
	...
	public Object postSync(String url, Header[] headers, CommonParams params,
			String contentType) {
		HttpEntityEnclosingRequestBase request = new HttpPost(url);
		if (params != null)
			request.setEntity(paramsToEntity(params));
	 ...
	 * @param callBack
	 */
	public void put(String url, CommonCallBack<? extends Object> callBack) {
		put(url, null, callBack);
	}

	public void put(String url, CommonParams params,
			CommonCallBack<? extends Object> callBack) {
	...
	public Object putSync(String url, CommonParams params) {
	 ...
	 * @param callBack
	 */
	public void delete(String url, CommonCallBack<? extends Object> callBack) {
	...
	public HttpHandler<File> download(String url, String target,
			boolean isResume, CommonCallBack<File> callback) {
		return download(url, null, target, isResume, callback);
	}

	public HttpHandler<File> download(String url, CommonParams params,
			String target, CommonCallBack<File> callback) {
		return download(url, params, target, false, callback);
	}

	public HttpHandler<File> download(String url, CommonParams params,
			String target, boolean isResume, CommonCallBack<File> callback) {
	...
	protected <T> void sendRequest(DefaultHttpClient client,
			...
			String contentType, CommonCallBack<T> ajaxCallBack) {
		if (contentType != null) {
	...
	public static String getUrlWithQueryString(String url, CommonParams params) {
		if (params != null) {
	...
	private HttpEntity paramsToEntity(CommonParams params) {
